...
<h1 align="center"> Bolt Utilities  </h1>
<p align="center">
<p align="center">
<a href="https://discord.gg/2SfcKxNt4G"><img alt="Support Server" src="https://img.shields.io/badge/Discord-7289DA?style=for-the-badge&logo=discord&logoColor=white"></a>
</p>
...
- **Leave your suggestions right [here](https://discord.gg/zxnmyfBzpq) then!**

## What features does Bolt Include?
...
- **Keep checking the [Releases Section]https://github.com/Minion9113/Bolt-Utilities/releases) to get the latest info relating new updates, bug fixes etc about the repository.**
...
## Getting started
#### Creating a fork:
- 1). [Click here to fork the repository](https://github.com/Minion9113/Bolt-Utilities)
- 2). Open your terminal and type `git clone https://github.com/Minion9113/Bolt-Utilities.git`
...
## Contributing
- **Before contributing to this repo, make sure to read [CONTRIBUTIONS.md](https://github.com/Minion9113/Bolt-Utilities/blob/master/CONTRIBUTIONS.md)**
- **Join our [Community server]([https://discord.gg/zxnmyfBzpq](https://discord.gg/2SfcKxNt4G))**
