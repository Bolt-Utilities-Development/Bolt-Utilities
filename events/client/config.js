module.exports = {
  OWNER_IDS: [42420623629344001], // Bot owner ID's
  ...
  DASHBOARD: {
    ...
    baseURL: "https://discord-bot.minionbob85.repl.co", // base url
    failureURL: "https://discord-bot.minionbob85.repl.co", // failure redirect url
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "951133035963744287", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
