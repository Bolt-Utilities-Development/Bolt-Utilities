...
module.exports = async(interaction, client) => {
    ...
    if (interaction.customId === "help_menu") {
        ...
        .setDescription(
          "`antilink`, `antiwords`, `autorole`, `dashboard`, `joinchannel`, `joinmessage` `leavechannel`, `leavemessage`, `prefix`, `setdropdownrole`, `setverify`"
        )
        .setColor("RANDOM");
      ...
      await msg.edit({ embeds: [settingsEmbed] });
        ...
        await msg.edit({ embeds: [infoEmbed] })
            ...
            .setDescription(
              "`ban`, `clear`, `dm`, `kick`, `lock`, `mute`, `note`, `timeout`, `removetimeout`, `warn`, `warnings`, `removewarn`, `slowmode`, `softban`, `unban`, `unlock`, `unmute`"
            )
            .setColor("RANDOM");
